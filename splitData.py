...
# AFTER CREATING SPLIT DATA DIRECTORIES
# Create a dataOffline.yaml file in SplitData directory then,
# CHANGE THIS YAML FILE'S () PATHS TO complete path till \SplitData
